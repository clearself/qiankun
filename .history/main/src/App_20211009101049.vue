<template>
    <div id="app">
        <div class="layout-header">
            <a style="display: inline-block;width: 80px;height: 80px;position: absolute;top: 0;right: 0;z-index: 1;" href="https://github.com/clearself/qiankun" class="github-corner" aria-label="View source on GitHub">
            ...
            <div class="logo">微前端(qiankun)架构应用</div>
            <ul class="sub-apps">
