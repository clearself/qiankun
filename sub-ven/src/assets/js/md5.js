...
md5.js
*/
const MD5 = function(bit, message) {
    ...
    if (bit == 32) {
        return (WordToHex(a) + WordToHex(b) + WordToHex(c) + WordToHex(d)).toLocaleUpperCase()
    } else {
        return (WordToHex(b) + WordToHex(c)).toLocaleUpperCase()
    }
}
